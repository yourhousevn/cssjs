...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://your-house.vn' target='_blank'><img src='https://3.bp.blogspot.com/-Wk7FZLLdFQ4/WmAmSpvnXCI/AAAAAAAAC4M/_OjxayNmVIkfdJv0UC83UNT0IEzrWNwQQCLcBGAs/s320/500.jpg' width='500px'/><br/>Thông Tin Căn Hộ</a> Xem Ngay <h2><a class='close-linhnguyen-modal'>X</a></h2>");
			$('#myModal').your-house($('#myModal').data());
		}
});
