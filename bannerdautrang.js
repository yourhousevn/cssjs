//please contact me minhphungdkb@gmail.com
//website http://your-house.vn or http://your-house.vn

(function($) {
    $.fn.Minhphung = function(options) {        
        var defaults = {  
	    	animation: 'fadeAndPop', //fade, fadeAndPop, none
		    animationspeed: 300, //how fast animtions are
		    closeonbackgroundclick: true, //if you click background will modal close?
		    dismissmodalclass: 'close-minhphung-modal' //the class of a button or element that will close an open modal
    	}; 
...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://your-house.vn' target='_blank'><img src='Hinhanh' width='500px'/><br/>13 Kỹ thuật đẩy top vượt trội</a>. Học tại nhà CEO Faceseo. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
